...
本ドキュメントは、自律型コーディングエージェント (Jules / Devin / Codex / Claude Code / GitHub Copilot / Cursor / Cline / Windsurf / Aider / Sweep / PR-Agent 等) が、公開 OSS リポジトリ [`genzouw/toique`](https://github.com/genzouw/toique) で作業し Pull Request を作成するときに **必ず守るべき規範** を定義します。
...
- [`.github/AI_AUTOMATION_SETUP.md`](.github/AI_AUTOMATION_SETUP.md) — AI / 自動化の導入手順と、無料方針の背景 (第5節)
- [`CONTRIBUTING.md`](CONTRIBUTING.md) — コントリビューションガイド
- [`SECURITY.md`](SECURITY.md) — セキュリティポリシー
- [`.github/copilot-instructions.md`](.github/copilot-instructions.md) — GitHub Copilot 向け指示
- [`.cursorrules`](.cursorrules) / [`.clinerules`](.clinerules) / [`.windsurfrules`](.windsurfrules) — 各エージェント向け指示
