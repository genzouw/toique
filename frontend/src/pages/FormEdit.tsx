      ...
      <div className="mt-3 flex items-start justify-between">
        ...
        {!isNew && (
          <button
            ...
            className="p-2 text-red-600 hover:bg-red-50 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-1 transition-colors"
            title="フォームを削除"
            aria-label="フォームを削除"
          >
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            >
              <button
                ...
                className={`px-3 py-1 text-xs rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900 focus-visible:ring-offset-1 transition-colors ${
                  tab === 'visual'
