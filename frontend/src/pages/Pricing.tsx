            ...
            >
              ...
              {plan.highlight && session?.user ? (
                <LoadingButton
                  ...
                  loading={upgrading}
                  className="mt-6 flex w-full items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium rounded-md bg-slate-900 text-white hover:bg-slate-800 disabled:opacity-50 disabled:cursor-not-allowed focus-ring transition-colors"
                >
