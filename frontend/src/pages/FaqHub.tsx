        ...
        <div className="max-w-2xl mx-auto">
          <div className="relative block">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2.5 border border-slate-300 rounded-md text-sm text-slate-900 placeholder:text-slate-400 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-slate-900 focus-visible:border-slate-900"
            />
          </div>
        </div>
      </section>
    ...
    return (
      <div className="text-center py-10">
        ...
        <p className="mt-2 text-sm text-slate-600">
          ...
          <Link
            to="/contact"
            className="underline text-slate-900 focus-ring focus-visible:outline-hidden rounded-sm transition-colors"
          >
            お問い合わせフォーム
          </Link>
          よりお寄せください。
