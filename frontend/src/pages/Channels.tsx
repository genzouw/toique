  ...
  return (
    <div>
      ...
      <input
        ...
        required={required}
        className="mt-1 w-full px-3 py-2 border border-slate-300 rounded-md text-sm focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-slate-900"
      />
    </div>
  );
}
