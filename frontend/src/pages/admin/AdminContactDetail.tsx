        ...
        <div className="flex gap-2">
          {STATUSES.map((s) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-md text-sm border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900 focus-visible:ring-offset-2 transition-colors ${
                detail.status === s
