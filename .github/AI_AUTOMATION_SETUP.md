...
### Gemini Code Review の導入 (2025年最新)

2025年の生成AIを用いた高度なレビュー自動化トレンドに合わせ、`derailed-dash/gemini-review-action` を利用したAI PR Code Review ワークフロー (`.github/workflows/gemini-review.yml`) を新設しました。
